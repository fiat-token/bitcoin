...
public:
    CMainParams() {
        ...
        CAmount coinMartellato = 100000000;
        genesis = CreateGenesisBlock(1231006505, 2083236893, 0x1d00ffff, 1, 50 * coinMartellato);
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1296688602, 414098458, 0x1d00ffff, 1, 50 * 100000000);
        consensus.hashGenesisBlock = genesis.GetHash();
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1296688602, 2, 0x207fffff, 1, 50 * 100000000);
        consensus.hashGenesisBlock = genesis.GetHash();
